...
describe('query', function ( ) {
  ...
  it('should provide default options', function ( ) {
    ...
    var low = dayjs.utc().subtract(4, 'days').subtract(1, 'minutes').format();
    var high = dayjs.utc().subtract(4, 'days').add(1, 'minutes').format();
  ...
  it('should not override non default options', function ( ) {
    ...
    var low = dayjs.utc().subtract(2, 'days').subtract(1, 'minutes').format();
    var high = dayjs.utc().subtract(2, 'days').add(1, 'minutes').format();
