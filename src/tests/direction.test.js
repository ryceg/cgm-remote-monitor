...
describe("BG direction", function () {
  ...
  it("set a pill to the direction", function (done) {
    ...
    var sbx = setupSandbox(
      { sgvs: [{ mills: now, direction: "Flat" }] },
      pluginBase,
    );
    var direction = require("../lib/plugins/direction")();
    direction.setProperties(sbx);
  ...
  it("get the info for a direction", function () {
    ...
    direction
      .info({ mills: now, direction: "DoubleUp" })
      .label.should.equal("⇈");
    direction
      .info({ mills: now, direction: "DoubleUp" })
      .entity.should.equal("&#8648;");
    ...
    direction
      .info({ mills: now, direction: "SingleUp" })
      .label.should.equal("↑");
    direction
      .info({ mills: now, direction: "SingleUp" })
      .entity.should.equal("&#8593;");
    ...
    direction
      .info({ mills: now, direction: "FortyFiveUp" })
      .label.should.equal("↗");
    direction
      .info({ mills: now, direction: "FortyFiveUp" })
      .entity.should.equal("&#8599;");
    ...
    direction
      .info({ mills: now, direction: "Flat" })
      .entity.should.equal("&#8594;");

    direction
      .info({ mills: now, direction: "FortyFiveDown" })
      .label.should.equal("↘");
    direction
      .info({ mills: now, direction: "FortyFiveDown" })
      .entity.should.equal("&#8600;");
    ...
    direction
      .info({ mills: now, direction: "SingleDown" })
      .label.should.equal("↓");
    direction
      .info({ mills: now, direction: "SingleDown" })
      .entity.should.equal("&#8595;");
    ...
    direction
      .info({ mills: now, direction: "DoubleDown" })
      .label.should.equal("⇊");
    direction
      .info({ mills: now, direction: "DoubleDown" })
      .entity.should.equal("&#8650;");
    ...
    direction
      .info({ mills: now, direction: "NOT COMPUTABLE" })
      .label.should.equal("-");
    direction
      .info({ mills: now, direction: "NOT COMPUTABLE" })
      .entity.should.equal("&#45;");
    ...
    direction
      .info({ mills: now, direction: "RATE OUT OF RANGE" })
      .label.should.equal("⇕");
    direction
      .info({ mills: now, direction: "RATE OUT OF RANGE" })
      .entity.should.equal("&#8661;");
