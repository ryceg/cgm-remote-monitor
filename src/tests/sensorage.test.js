      ...
      sensorTreatments: [
        {
          ...
          notes: "Foo",
          mills: Date.now() - times.days(2).msecs,
        },
        {
          eventType: "Sensor Start",
          notes: "Bar",
          mills: Date.now() - times.days(1).msecs,
        },
      ],
    };
      ...
      sensorTreatments: [
        {
          eventType: "Sensor Start",
          notes: "Bar",
          mills: Date.now() - times.days(3).msecs,
        },
      ],
    };
      ...
      sensorTreatments: [
        {
          eventType: "Sensor Start",
          notes: "Bar",
          mills: Date.now() - times.days(10).msecs,
        },
        {
          eventType: "Sensor Change",
          notes: "Foo",
