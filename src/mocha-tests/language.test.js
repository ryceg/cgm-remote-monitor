...
describe("language", function () {
  ...
  it("replace strings in translations", function () {
    var language = require("../lib/language")();
    language
      .translate("%1 records deleted", "1")
      .should.equal("1 records deleted");
    language
      .translate("%1 records deleted", 1)
      .should.equal("1 records deleted");
    language
      .translate("%1 records deleted", { params: ["1"] })
      .should.equal("1 records deleted");
    language
      .translate("Sensor age %1 days %2 hours", "1", "2")
      .should.equal("Sensor age 1 days 2 hours");
  });
