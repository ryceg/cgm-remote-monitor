    ...
    const BRUSH_EXTENTS = [
      {
        ...
        times: [200, 300],
        expectedOpacity: 0.5,
        expectation: "Uses default opacity",
      },
      {
        mills: 300,
        times: [100, 200],
      ...
      },
      {
        ...
        times: [100, 300],
        expectedOpacity: 1,
        expectation: "Calculates opacity",
      },
    ];
    ...
    _.forEach(BRUSH_EXTENTS, (extent) => {
        ...
        chart: {
          ...
          createAdjustedRange: () => {
            return [
              {
                getTime: () => {
                  return extent.times[0];
                },
              },
              {
                getTime: () => {
                  return extent.times[1];
                },
              },
            ];
          },
      ...
      describe(`data.mills ${extent.mills} and chart().brush.extent() times ${extent.times}`, () => {
        it(extent.expectation, () => {
          ...
          renderer(mockClient, {})
            .highlightBrushPoints(mockData, from, to)
            .should.equal(extent.expectedOpacity);
        });
      });
    });
  });
