  ...
  },
  {
    ...
    openaps: {
      ...
      suggested: {
        ...
        IOB: 1.016,
        reason:
          "COB: 0, Dev: -6, BGI: -2.22, ISF: 31, Target: 80, minPredBG 78, IOBpredBG 78; Eventual BG 80 >= 80,  insulinReq -0.06. temp 0.2<0.75U/hr. ",
        COB: 0,
        eventualBG: 80,
        duration: 30,
        tick: -3,
      ...
      enacted: {
        ...
        predBGs: {
          IOB: [
            117, 114, 111, 108, 106, 104, 102, 100, 98, 97, 96, 95, 94, 93, 92,
            91, 90, 89, 88, 87, 86, 86, 85, 84, 83, 83, 82, 81, 81, 81, 80, 80,
            79, 79, 79, 79, 78,
          ],
        },
        minPredBG: 78,
...
describe("openaps", function () {
  ...
  it("check the recieved flag to see if it was received", function (done) {
    ...
    var sbx = require("../lib/sandbox")().clientInit(ctx, now, {
      devicestatus: notStatuses,
    });
  ...
  it("not generate an alert for a stuck loop, when there is an offline marker", function (done) {
    ...
    var sbx = sandbox.clientInit(ctx, now.clone().add(1, "hours").valueOf(), {
      devicestatus: statuses,
      treatments: [
        { eventType: "OpenAPS Offline", mills: now.valueOf(), duration: 60 },
      ],
    });
    sbx.extendedSettings = { enableAlerts: "TRUE" };
    openaps.setProperties(sbx);
