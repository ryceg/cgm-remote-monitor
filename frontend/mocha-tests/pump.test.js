...
describe("pump", function () {
  ...
  it("generate an urgent alarm when battery is really low", function (done) {
    ...
    var lowBattStatuses = _.cloneDeep(statuses);
    lowBattStatuses[1].pump.battery.voltage = 1.0;
