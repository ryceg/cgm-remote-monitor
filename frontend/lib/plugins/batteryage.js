...
function init(ctx) {
    ...
    bage.checkNotifications = function checkNotifications(sbx) {
        ...
        if (batteryInfo.notification) {
            var notification = Object.assign({}, batteryInfo.notification, {
                                        plugin: bage
                                        , debug: {
                                        age: batteryInfo.age
                                        }
    ...
    bage.findLatestTimeChange = function findLatestTimeChange(sbx) {
        ...
        sbx.data.batteryTreatments?.forEach(function eachTreatment (treatment) {
               ...
               var b = dayjs(batteryInfo.treatmentDate);
    ...
    bage.updateVisualisation = function updateVisualisation (sbx) {
        ...
        if (batteryInfo?.notes && batteryInfo.notes.length > 0) {
